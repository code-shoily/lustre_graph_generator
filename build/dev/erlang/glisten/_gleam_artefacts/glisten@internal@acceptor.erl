...
-type pool(OXG, OXH) :: {pool,
        fun((OXG, glisten@internal@handler:loop_message(OXH), glisten@internal@handler:connection(OXH)) -> glisten@internal@handler:next(OXG, glisten@internal@handler:loop_message(OXH))),
        integer(),
        fun((glisten@internal@handler:connection(OXH)) -> {OXG,
            gleam@option:option(gleam@erlang@process:selector(OXH))}),
        gleam@option:option(fun((OXG) -> nil)),
        glisten@transport:transport()}.
