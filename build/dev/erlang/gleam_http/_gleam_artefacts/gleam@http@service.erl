...
-spec map_response_body(
    fun((GFW) -> gleam@http@response:response(GFX)),
    fun((GFX) -> GFZ)
) -> fun((GFW) -> gleam@http@response:response(GFZ)).
...
-spec prepend_response_header(
    fun((GGB) -> gleam@http@response:response(GGC)),
    binary(),
    binary()
) -> fun((GGB) -> gleam@http@response:response(GGC)).
...
-spec ensure_post(gleam@http@request:request(GGF)) -> {ok,
        gleam@http@request:request(GGF)} |
    {error, nil}.
ensure_post(Req) ->
...
-spec method_override(fun((gleam@http@request:request(GGO)) -> GGQ)) -> fun((gleam@http@request:request(GGO)) -> GGQ).
