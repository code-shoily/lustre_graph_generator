...
-spec add_node(yog@model:graph(AMXC, AMXD), integer(), AMXC) -> yog@model:graph(AMXC, AMXD).
...
-spec add_edge(yog@model:graph(AMXI, AMXJ), integer(), integer(), AMXJ) -> yog@model:graph(AMXI, AMXJ).
...
-spec add_unweighted_edge(yog@model:graph(AMXO, nil), integer(), integer()) -> yog@model:graph(AMXO, nil).
...
-spec add_simple_edge(yog@model:graph(AMXT, integer()), integer(), integer()) -> yog@model:graph(AMXT, integer()).
...
-spec successors(yog@model:graph(any(), AMXZ), integer()) -> list({integer(),
    AMXZ}).
successors(Graph, Id) ->
...
-spec predecessors(yog@model:graph(any(), AMYE), integer()) -> list({integer(),
    AMYE}).
...
-spec neighbors(yog@model:graph(any(), AMYJ), integer()) -> list({integer(),
    AMYJ}).
neighbors(Graph, Id) ->
...
-spec from_edges(yog@model:graph_type(), list({integer(), integer(), AMYS})) -> yog@model:graph(nil, AMYS).
...
-spec from_adjacency_list(
    yog@model:graph_type(),
    list({integer(), list({integer(), AMYZ})})
) -> yog@model:graph(nil, AMYZ).
