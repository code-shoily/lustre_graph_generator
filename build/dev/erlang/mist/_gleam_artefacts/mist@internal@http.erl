...
?DOC(false).
-spec add_date_header(gleam@http@response:response(ABFN)) -> gleam@http@response:response(ABFN).
...
?DOC(false).
-spec connection_close(gleam@http@response:response(ABFQ)) -> gleam@http@response:response(ABFQ).
...
?DOC(false).
-spec keep_alive(gleam@http@response:response(ABFT)) -> gleam@http@response:response(ABFT).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
?DOC(false).
-spec maybe_keep_alive(gleam@http@response:response(ABFW)) -> gleam@http@response:response(ABFW).
...
?DOC(false).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(ABGB)) -> gleam@http@response:response(ABGB)).
