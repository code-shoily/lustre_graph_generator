...
-spec namespaced(
    ...
    list(lustre@vdom@vnode:element(SJM))
) -> lustre@vdom@vnode:element(SJM).
...
-spec advanced(
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(SJS)),
    list(lustre@vdom@vnode:element(SJS)),
    boolean(),
    boolean()
) -> lustre@vdom@vnode:element(SJS).
...
-spec fragment(list(lustre@vdom@vnode:element(SKC))) -> lustre@vdom@vnode:element(SKC).
fragment(Children) ->
...
-spec memo(
    ...
    fun(() -> lustre@vdom@vnode:element(SKL))
) -> lustre@vdom@vnode:element(SKL).
...
-spec map(lustre@vdom@vnode:element(SKP), fun((SKP) -> SKR)) -> lustre@vdom@vnode:element(SKR).
map(Element, F) ->
