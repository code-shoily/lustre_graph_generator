...
-spec find_matching_in_list(
    list(lustre@vdom@vnode:element(XQH)),
    selector(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(XQH), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_direct_child(
    lustre@vdom@vnode:element(XQC),
    selector(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(XQC), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_all_matching_in_list(
    list(lustre@vdom@vnode:element(XRP)),
    selector()
) -> list(lustre@vdom@vnode:element(XRP)).
...
-spec find_all_direct_children(lustre@vdom@vnode:element(XRL), selector()) -> list(lustre@vdom@vnode:element(XRL)).
...
-spec find_all_in_list(list(lustre@vdom@vnode:element(XRG)), 'query'()) -> list(lustre@vdom@vnode:element(XRG)).
...
-spec find_all(lustre@vdom@vnode:element(XQY), 'query'()) -> list(lustre@vdom@vnode:element(XQY)).
find_all(Root, Query) ->
    case Query of
        {find_element, Selector} ->
...
-spec find_all_in_children(lustre@vdom@vnode:element(XRC), 'query'()) -> list(lustre@vdom@vnode:element(XRC)).
...
-spec find_all_descendants_in_list(
    list(lustre@vdom@vnode:element(XRY)),
    selector()
) -> list(lustre@vdom@vnode:element(XRY)).
...
-spec find_all_descendants(lustre@vdom@vnode:element(XRU), selector()) -> list(lustre@vdom@vnode:element(XRU)).
...
-spec find_in_list(
    list(lustre@vdom@vnode:element(XPW)),
    'query'(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(XPW), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_path(
    ...
    integer(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(XPM), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_in_children(
    lustre@vdom@vnode:element(XPR),
    'query'(),
    integer(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(XPR), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find(lustre@vdom@vnode:element(XPH), 'query'()) -> {ok,
        lustre@vdom@vnode:element(XPH)} |
    {error, nil}.
find(Root, Query) ->
...
-spec find_descendant_in_list(
    list(lustre@vdom@vnode:element(XQS)),
    selector(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(XQS), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_descendant(
    lustre@vdom@vnode:element(XQN),
    selector(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(XQN), lustre@vdom@path:path()}} |
    {error, nil}.
