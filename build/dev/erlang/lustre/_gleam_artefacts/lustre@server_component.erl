...
-spec element(
    list(lustre@vdom@vattr:attribute(AAWE)),
    list(lustre@vdom@vnode:element(AAWE))
) -> lustre@vdom@vnode:element(AAWE).
...
-spec include(lustre@vdom@vattr:attribute(AAWQ), list(binary())) -> lustre@vdom@vattr:attribute(AAWQ).
...
-spec subject(lustre:runtime(AAWU)) -> gleam@erlang@process:subject(lustre@runtime@server@runtime:message(AAWU)).
subject(Runtime) ->
...
-spec register_subject(
    gleam@erlang@process:subject(lustre@runtime@transport:client_message(AAXC))
) -> lustre@runtime@server@runtime:message(AAXC).
...
-spec deregister_subject(
    gleam@erlang@process:subject(lustre@runtime@transport:client_message(AAXG))
) -> lustre@runtime@server@runtime:message(AAXG).
...
-spec register_callback(
    fun((lustre@runtime@transport:client_message(AAXK)) -> nil)
) -> lustre@runtime@server@runtime:message(AAXK).
...
-spec deregister_callback(
    fun((lustre@runtime@transport:client_message(AAXN)) -> nil)
) -> lustre@runtime@server@runtime:message(AAXN).
...
-spec select(
    fun((fun((AAXS) -> nil), gleam@erlang@process:subject(any())) -> gleam@erlang@process:selector(AAXS))
) -> lustre@effect:effect(AAXS).
select(Sel) ->
