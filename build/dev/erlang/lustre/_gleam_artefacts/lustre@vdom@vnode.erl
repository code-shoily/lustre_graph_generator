...
-type element(RYS) :: {fragment,
        integer(),
        binary(),
        list(element(RYS)),
        lustre@internals@mutable_map:mutable_map(binary(), element(RYS))} |
    {element,
        integer(),
        binary(),
        binary(),
        binary(),
        list(lustre@vdom@vattr:attribute(RYS)),
        list(element(RYS)),
        lustre@internals@mutable_map:mutable_map(binary(), element(RYS)),
        boolean(),
        boolean()} |
...
?DOC(false).
-spec to_keyed(binary(), element(SAG)) -> element(SAG).
to_keyed(Key, Node) ->
    case Node of
...
-spec fragment(
    binary(),
    list(element(RZA)),
    lustre@internals@mutable_map:mutable_map(binary(), element(RZA))
) -> element(RZA).
...
-spec element(
    ...
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(RZH)),
    list(element(RZH)),
    lustre@internals@mutable_map:mutable_map(binary(), element(RZH)),
    boolean(),
    boolean()
) -> element(RZH).
element(
...
-spec unsafe_inner_html(
    ...
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(RZS)),
    binary()
) -> element(RZS).
...
?DOC(false).
-spec map(element(RZW), fun((RZW) -> RZY)) -> element(RZY).
map(Element, Mapper) ->
    case Element of
...
?DOC(false).
-spec memo(binary(), list(lustre@internals@ref:ref()), fun(() -> element(SAB))) -> element(SAB).
...
-spec fragment_to_json(
    ...
    binary(),
    list(element(SAJ)),
    lustre@internals@mutable_map:mutable_map(fun(() -> element(SAJ)), element(SAJ))
) -> gleam@json:json().
