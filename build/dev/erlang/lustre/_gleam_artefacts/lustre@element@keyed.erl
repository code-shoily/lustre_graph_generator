...
-spec do_extract_keyed_children(
    list({binary(), lustre@vdom@vnode:element(YOW)}),
    lustre@internals@mutable_map:mutable_map(binary(), lustre@vdom@vnode:element(YOW)),
    list(lustre@vdom@vnode:element(YOW))
) -> {lustre@internals@mutable_map:mutable_map(binary(), lustre@vdom@vnode:element(YOW)),
    list(lustre@vdom@vnode:element(YOW))}.
...
-spec extract_keyed_children(list({binary(), lustre@vdom@vnode:element(YOO)})) -> {lustre@internals@mutable_map:mutable_map(binary(), lustre@vdom@vnode:element(YOO)),
    list(lustre@vdom@vnode:element(YOO))}.
...
-spec element(
    binary(),
    list(lustre@vdom@vattr:attribute(YMU)),
    list({binary(), lustre@vdom@vnode:element(YMU)})
) -> lustre@vdom@vnode:element(YMU).
...
-spec namespaced(
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(YNA)),
    list({binary(), lustre@vdom@vnode:element(YNA)})
) -> lustre@vdom@vnode:element(YNA).
...
-spec fragment(list({binary(), lustre@vdom@vnode:element(YNG)})) -> lustre@vdom@vnode:element(YNG).
fragment(Children) ->
    {Keyed_children, Children@1} = extract_keyed_children(Children),
...
-spec ul(
    ...
    list({binary(), lustre@vdom@vnode:element(YNK)})
...
-spec ol(
    ...
    list({binary(), lustre@vdom@vnode:element(YNQ)})
...
-spec 'div'(
    ...
    list({binary(), lustre@vdom@vnode:element(YNW)})
...
-spec tbody(
    ...
    list({binary(), lustre@vdom@vnode:element(YOC)})
...
-spec dl(
    list(lustre@vdom@vattr:attribute(YOI)),
    list({binary(), lustre@vdom@vnode:element(YOI)})
) -> lustre@vdom@vnode:element(YOI).
