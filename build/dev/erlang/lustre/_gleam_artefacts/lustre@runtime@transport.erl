...
-type client_message(TYD) :: {mount,
        ...
        lustre@vdom@vnode:element(TYD),
        lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(TYD)), lustre@vdom@vnode:element(TYD))} |
    {reconcile,
        integer(),
        lustre@vdom@patch:patch(TYD),
        lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(TYD)), lustre@vdom@vnode:element(TYD))} |
...
-spec mount_to_json(
    ...
    list(binary()),
    gleam@dict:dict(binary(), gleam@json:json()),
    lustre@vdom@vnode:element(TZD),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(TZD)), lustre@vdom@vnode:element(TZD))
) -> gleam@json:json().
mount_to_json(
    Kind,
    Open_shadow_root,
...
-spec reconcile_to_json(
    integer(),
    lustre@vdom@patch:patch(TZG),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(TZG)), lustre@vdom@vnode:element(TZG))
) -> gleam@json:json().
...
-spec mount(
    ...
    list(binary()),
    gleam@dict:dict(binary(), gleam@json:json()),
    lustre@vdom@vnode:element(TYJ),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(TYJ)), lustre@vdom@vnode:element(TYJ))
) -> client_message(TYJ).
mount(
    Open_shadow_root,
    Will_adopt_styles,
...
?DOC(false).
-spec reconcile(
    lustre@vdom@patch:patch(TYN),
    lustre@internals@mutable_map:mutable_map(fun(() -> lustre@vdom@vnode:element(TYN)), lustre@vdom@vnode:element(TYN))
) -> client_message(TYN).
