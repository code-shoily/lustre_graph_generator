...
export class Continue<ABVK, ABVL> extends _.CustomType {
  /** @deprecated */
...
export function Next$isContinue<ABVL, ABVK>(value: Next$<ABVK, ABVL>): boolean;
export function Next$Continue$0<ABVK, ABVL>(value: Next$<ABVK, ABVL>): ABVK;
...
export function Next$NormalStop<ABVK, ABVL>(): Next$<ABVK, ABVL>;
...
export type Next$<ABVK, ABVL> = Continue<ABVK, ABVL> | NormalStop | AbnormalStop;
