...
-type graph(GFF, GFG) :: {graph,
        graph_type(),
        gleam@dict:dict(integer(), GFF),
        gleam@dict:dict(integer(), gleam@dict:dict(integer(), GFG)),
        gleam@dict:dict(integer(), gleam@dict:dict(integer(), GFG))}.
...
-spec add_node(graph(GFL, GFM), integer(), GFL) -> graph(GFL, GFM).
...
-spec successors(graph(any(), GFY), integer()) -> list({integer(), GFY}).
successors(Graph, Id) ->
...
-spec predecessors(graph(any(), GGD), integer()) -> list({integer(), GGD}).
...
-spec neighbors(graph(any(), GGI), integer()) -> list({integer(), GGI}).
neighbors(Graph, Id) ->
...
-spec do_add_directed_edge(graph(GHA, GHB), integer(), integer(), GHB) -> graph(GHA, GHB).
...
-spec add_edge(graph(GFR, GFS), integer(), integer(), GFS) -> graph(GFR, GFS).
...
-spec remove_node(graph(GHG, GHH), integer()) -> graph(GHG, GHH).
